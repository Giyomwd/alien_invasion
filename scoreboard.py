...
class Scoreboard():
    ...
    def prep_score(self):
        ...
        self.score_image = self.font.render(score_str,True,self.text_color,self.ai_settings.background_color) #font.render()将文本信息转换成图像
    ...
    def prep_high_score(self):
        ...
        self.high_score_image = self.font.render(high_score_str, True,self.text_color,self.ai_settings.background_color)  # font.render()将文本信息转换成图像
        # 将最高分放在屏幕顶部中央
